...
- Keep public preview files in `assets/exports/` and `assets/thumbnails/` as normal Git blobs so GitHub can render them. Reserve Git LFS for `assets/originals/`, `assets/references/`, source files, and archives.
